...
function callTests.test_airy()
    ...
    tester:assert(cephes.airy(x, ai, aip, bi, bip) ~= nil)
end
...
function callTests.test_hyp2f1()
    ...
    local c = 0.5
    local x = 0.5
    tester:assert(cephes.hyp2f1(a, b, c, x) ~= nil)
end
...
function callTests.test_hyperg()
    ...
    local b = 0.5
    local x = 0.5
    tester:assert(cephes.hyperg(a, b, x) ~= nil)
end
...
function callTests.test_hyp2f0()
    ...
    tester:assert(cephes.hyp2f0(a, b, x, type, err) ~= nil)
end
...
function callTests.test_i0e()
    local x = 0.5
    tester:assert(cephes.i0e(x) ~= nil)
end
...
function callTests.test_i1e()
    local x = 0.5
    tester:assert(cephes.i1e(x) ~= nil)
end
...
function callTests.test_iv()
    local v = 0.5
    local x = 0.5
    tester:assert(cephes.iv(v, x) ~= nil)
end
...
function callTests.test_jn()
    local n = 1
    local x = 0.5
    tester:assert(cephes.jn(n, x) ~= nil)
end
...
function callTests.test_jv()
    local n = 0.5
    local x = 0.5
    tester:assert(cephes.jv(n, x) ~= nil)
end
...
function callTests.test_k0e()
    local x = 0.5
    tester:assert(cephes.k0e(x) ~= nil)
end
...
function callTests.test_k1e()
    local x = 0.5
    tester:assert(cephes.k1e(x) ~= nil)
end
...
function callTests.test_kn()
    local nn = 1
    local x = 0.5
    tester:assert(cephes.kn(nn, x) ~= nil)
end
...
function callTests.test_psi()
    local x = 0.5
    tester:assert(cephes.psi(x) ~= nil)
...
function callTests.test_onef2()
    ...
    local x = 0.5
    local err = ffi.new("double[1]", {0})
    tester:assert(cephes.onef2(a, b, c, x, err) ~= nil)
end
...
function callTests.test_threef0()
    ...
    local x = 0.5
    local err = ffi.new("double[1]", {0})
    tester:assert(cephes.threef0(a, b, c, x, err) ~= nil)
end
...
function callTests.test_struve()
    local v = 0.5
    local x = 0.5
    tester:assert(cephes.struve(v, x) ~= nil)
end
...
function callTests.test_yn()
    local n = 1
    local x = 0.5
    tester:assert(cephes.yn(n, x) ~= nil)
end
